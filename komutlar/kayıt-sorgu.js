...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ['KULLANICAK ROL ID 1', 'KULLANICAK ROL ID 2'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
